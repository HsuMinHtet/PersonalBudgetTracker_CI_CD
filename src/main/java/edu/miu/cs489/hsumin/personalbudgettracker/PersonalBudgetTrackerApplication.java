...
public class PersonalBudgetTrackerApplication {
    ...
    CommandLineRunner commandLineRunner(){
        return args -> {
            System.out.println();
            //Create User(Admin)
            UserRequestDTO userRequestDTO=new UserRequestDTO("Tim","641-233-9993","$2a$10$Maz./t.v9TTH4j.UcGBF/emsn8pXujIZAieygcPhoMloi9GTLAnn6", "admin@budget.com", Role.ADMIN);
